      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <Card style={styles.nameCard}>
            ...
            <Text style={[styles.nameText, { textAlign: 'center' }]}>Roel Bendania</Text>
          </Card>
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    marginBottom: isWideScreen ? 16 : 20,
  },
  ...
  nameCard: {
    paddingVertical: isWideScreen ? 34 : 34,
    borderRadius: isWideScreen ? 24 : 14,
  },
  nameLabelRow: {
    flexDirection: 'row',
    alignItems: 'center',
